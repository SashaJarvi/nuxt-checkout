  ...
  <div class="container">
    <main>
      <div class="py-5 text-center">
        <h2>Welcome</h2>
        <p class="lead">
          {{ user.first_name }} {{ user.last_name }} has invited you to buy this products
        </p>
      </div>
            ...
            <template v-for="product in products">
              ...
              <li class="list-group-item d-flex justify-content-between lh-sm">
                ...
                <input
                  ...
                  class="form-control text-muted quantity"
                  type="number"
                  min="0"
                >
              </li>
          ...
          <form class="needs-validation" novalidate="" @submit.prevent="submitHandler">
            <div class="row g-3">
              ...
              <div class="col-md-5">
                ...
                <input id="country" v-model="country" type="text" class="form-control" placeholder="Country">
              </div>

              <div class="col-md-4">
                <label for="city" class="form-label">City</label>
                <input id="city" v-model="city" type="text" class="form-control" placeholder="City">
              </div>

              <div class="col-md-3">
                <label for="zip" class="form-label">Zip</label>
                <input id="zip" v-model="zip" type="text" class="form-control" placeholder="Zip">
              </div>
            </div>
